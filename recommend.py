...
##==================================================================
def getAllUserRating(fileResult='result.txt', similarity=sim_pearson):
	prefer1 = loadMovieLensTrain()  # 加载训练集
	prefer2 = loadMovieLensTest()  # 加载测试集
	inAllnum = 0
